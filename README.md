...
|---|---|---|---|
| Anshu Patel | Sender | `GCEEVR6W3LPTPQ3UFSAP43UMBXAOMTVWPUOERWZF3MQQOSOOJLE4XFJD` | The ability to organize funds by purpose and see exactly when they are claimed is a game changer for family support. I would love an option to schedule recurring plans automatically every month. |
| Rahul Sharma | Receiver | `GCC3M4JQTMRE7RTD7SIIGLA3UQVNIAV5GEOVLUYBO5PZYNXBLITLCJR4` | Very smooth transaction speeds and almost zero fees are great, but it would be really helpful to add a notification system that emails me the exact moment my receiver claims the funds. |
| Malika Singh | Receiver | `GD3HSTZ27L7DWP7O2R2ATMAOLOPUIGCDSMT64TDETN4RI62VWQOIGI7F` | Freighter connection was seamless and the instant on-chain release of funds makes it incredibly reliable to get support when I need it. Maybe add a mobile app version in the future. |
| Vikram Mehta | Sender | `GAJ2QIUJDOZXC2MH2A5BFJIY5JIPR4YS4CTARPK7RGHSSMOW3ECDM5HC` | Overall excellent experience. Funding the plan was straightforward, but I think the dashboard could use a better filtering system to easily sort through older completed plans when you have many of them. |
| Priya Desai | Sender | `GDUTHXWDZYTCQIRZBX5NXSPFVUX6557WAQR23RDJGONV372RAKLWJ5BA` | I absolutely love the transparency this provides. It gives me peace of mind knowing exactly what the money is being used for. Perhaps you could implement a way to upload receipts directly into the platform. |
| Rohan Gupta | Sender | `GCMEP5X6OSWKEKM54MUX3P45GCXMN6L5HHKICWMIIGFUEEAFE3KLBG3X` | The smart contract integration works flawlessly. I successfully sent emergency funds across borders in seconds. My only suggestion is to support more fiat off-ramps for the receiver. |
| Sneha Reddy | Receiver | `GABKSGCQEFGT44YEGUYQ5KEATFFXJBZEBPFNTBQW6HCPD7K7BFYTJDCO` | Great platform for managing tuition payments for my sister abroad. It took a bit of time to understand how to approve allocations initially, so a small interactive tutorial on the first login would be nice. |
| Aditya Kumar | Sender | `GAPNZGQEZBHLJXOGALD5E7C7QASHR7U3SAZIZQRN4LZZR4G33HKRBJSQ` | Fast and reliable remittance. I tested it out for a housing renovation project and everything went perfectly. Tracking expenses against the total funded amount is super intuitive. |
| Neha Verma | Receiver | `GCSAPI32TRCP7XSYKMPO2PQ5ZKHYOGL2CCRLNRCHB5CACPH5M6DSRZ3B` | The concept of purpose-based allocations solves a huge problem in traditional remittances. I hope you can add a feature to easily convert the stellar tokens back to local currency directly within the app. |
| Arjun Iyer | Sender | `GDIG5IHYSFAG6CVGS3XYSORLVUPCDR6C2YYJDW2YAOIU25GDV7P3POYW` | Really impressed with the Soroban smart contract execution speed. The interface is clean and responsive. It would be awesome to allow multiple senders to contribute to a single plan like a family pool. |
| Kavita Rao | Receiver | `GCEEVR6W3LPTPQ3UFSAP43UMBXAOMTVWPUOERWZF3MQQOSOOJLE4XFJD` | Using this for my quarterly allowance has been incredibly stress-free. The transparent ledger means no more arguments about whether the money was sent or not. A dark mode toggle would be a sweet addition. |
