    ...
    <div>
      <section className="mx-auto max-w-6xl px-4 py-20 text-center">
        ...
        <div className="mt-8 flex justify-center gap-3">
          ...
          <Link to="/how-it-works" className="rounded-md border border-slate-300 px-5 py-3 text-sm font-medium text-navy hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800">
            How it works
          </Link>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
          {PURPOSES.map(({ icon: Icon, label }) => (
            <div key={label} className="rounded-xl border border-slate-200 bg-white p-6 text-center shadow-sm dark:bg-slate-800 dark:border-slate-700">
              <Icon className="mx-auto h-6 w-6 text-emerald" />
              <p className="mt-2 text-sm font-medium text-navy dark:text-slate-200">{label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16">
        <div className="rounded-xl border border-slate-200 bg-white p-8 dark:bg-slate-800 dark:border-slate-700">
          <ShieldCheck className="h-8 w-8 text-emerald" />
          <h2 className="mt-3 text-xl font-semibold text-navy dark:text-white">Every transfer is on-chain</h2>
